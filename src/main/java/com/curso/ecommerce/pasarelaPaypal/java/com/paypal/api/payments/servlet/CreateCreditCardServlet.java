...
package com.curso.ecommerce.pasarelaPaypal.java.com.paypal.api.payments.servlet;
...
public class CreateCreditCardServlet extends HttpServlet {
	...
	private static final Logger LOGGER = Logger.getLogger(String.valueOf(CreateCreditCardServlet.class));
