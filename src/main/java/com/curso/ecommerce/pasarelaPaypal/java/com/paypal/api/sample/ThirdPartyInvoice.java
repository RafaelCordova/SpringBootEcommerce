...
public class ThirdPartyInvoice extends SampleBase<Invoice> {
	...
	public Invoice create(APIContext context) throws PayPalRESTException, FileNotFoundException, IOException {
		...
		super.instance.getMerchantInfo().setEmail("tienda_pieles_malibu@gmail.com");
	...
	public static void main(String[] args) {
		try {
			...
			String apiKeyPaypal = "UdL0ZFrrevCFtvXHUwQNhpyboVu0qE6Lv1I6VU7TXrKPfOpvExYKVbI6iFs-AYhmMZVEWgdPXpaHD2nsv0ypk8riEgkpj-dXmmpfi_Ud9dGRt65uraIb9rKCqXpuUBNc2WbM1P8-CaOj5M6FxK_6sUh2nveShf66ZUj_fsuu1TrLTTY8";
			APIContext context = new APIContext(clientID, clientSecret, "sandbox");

			// Fetch the long lived refresh token from authorization code.
			String refreshToken = Invoice.fetchRefreshToken(context, apiKeyPaypal);
